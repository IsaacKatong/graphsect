...
- **graph-view/** — React components for the 3D force-directed graph visualization, the Grouped View mode, and the node detail panel.
- **grouping/** — Tag-based hierarchical partitioning and bottom-up 3D sphere-packed layout that powers Grouped View.
